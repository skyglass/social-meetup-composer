package skyglass.composer.meetup;
...
public class StreamingRsvpsDStream {
	...
	private static final String HADOOP_HOME_DIR_VALUE = "D:/development/winutils";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		final JavaStreamingContext streamingContext = new JavaStreamingContext(conf, new Duration(BATCH_DURATION_INTERVAL_MS));
		...
		JavaDStream<ConsumerRecord<String, String>> rsvpsWithGuestsStream = meetupStream.filter(f -> !f.value().contains("\"guests\":0"));
